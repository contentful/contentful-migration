...
module.exports = function (migration) {
  ...
  Event.createField('title').name('Title').localized(true).type('Symbol').defaultValue({
    'en-US': 'Default title'
  })

  Event.createField('advertised').name('Advertised').type('Boolean').localized(false).defaultValue({
    'en-US': true
  })

  Event.createField('startDate').name('Start Date').type('Date').localized(false).defaultValue({
  ...
  RefWithDefault.createField('ref')
    .name('Ref')
    .type('Link')
    .linkType('Entry')

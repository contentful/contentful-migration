module.exports = function (migration) {
  ...
  customSidebar.addSidebarWidget('sidebar-builtin', 'not-needed')
  ...
  customSidebar
    ...
    .updateSidebarWidget('extension', 'imageTaggingExtensionId', {
      tagField: 'tags',
      imageField: 'image'
    })

  customSidebar.removeSidebarWidget('sidebar-builtin', 'not-needed')
}

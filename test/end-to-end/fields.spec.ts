...
describe('apply field migration examples', () => {
  ...
  it('aborts 06-delete-field migration', async () => {
  ...
  it('applies 06-delete-field migration', async () => {
    await new Promise<void>((resolve, reject) => {
      cli()
        .run(
          `--space-id ${SOURCE_TEST_SPACE} --environment-id ${environmentId} ./examples/06-delete-field.js`
  ...
  it('aborts change-field-id migration', async () => {
    await new Promise<void>((resolve, reject) => {
      cli()
        .run(
  ...
  it('applies change-field-id migration', async () => {
    await new Promise<void>((resolve, reject) => {
      cli()
        .run(
          `--space-id ${SOURCE_TEST_SPACE} --environment-id ${environmentId} ./examples/change-field-id.js`
  ...
  it('aborts 07-display-field migration', async () => {
    await new Promise<void>((resolve, reject) => {
      cli()
        .run(
  ...
  it('applies 07-display-field migration', async () => {
    await new Promise<void>((resolve, reject) => {
      cli()
        .run(
          `--space-id ${SOURCE_TEST_SPACE} --environment-id ${environmentId} ./examples/07-display-field.js`
  ...
  it('aborts 08-move-field migration', async () => {
    await new Promise<void>((resolve, reject) => {
      cli()
        .run(
  ...
  it('applies 08-move-field migration', async () => {
    await new Promise<void>((resolve, reject) => {
      cli()
        .run(
          `--space-id ${SOURCE_TEST_SPACE} --environment-id ${environmentId} ./examples/08-move-field.js`

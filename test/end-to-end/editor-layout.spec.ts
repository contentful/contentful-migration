...
describe('apply editor layout migration examples', () => {
  ...
  it('aborts 35-create-editor-layout migration', (done) => {
    cli()
      .run(
  ...
  it('applies 35-create-editor-layout migration', (done) => {
    cli()
      .run(
        `--space-id ${SOURCE_TEST_SPACE} --environment-id ${environmentId} ./examples/35-create-editor-layout.js`
      )
  ...
  it('aborts 36-delete-editor-layout-tab migration', (done) => {
    cli()
      .run(
  ...
  it('applies 36-delete-editor-layout-tab migration', (done) => {
    cli()
      .run(
        `--space-id ${SOURCE_TEST_SPACE} --environment-id ${environmentId} ./examples/36-delete-editor-layout-tab.js`
      )
  ...
  it('aborts 37-delete-editor-layout-field-set migration', (done) => {
    cli()
      .run(
  ...
  it('applies 37-delete-editor-layout-field-set migration', (done) => {
    cli()
      .run(
        `--space-id ${SOURCE_TEST_SPACE} --environment-id ${environmentId} ./examples/37-delete-editor-layout-field-set.js`
      )
  ...
  it('aborts 38-change-field-group-id-editor-layout migration', (done) => {
    cli()
      .run(
  ...
  it('applies 38-change-field-group-id-editor-layout migration', (done) => {
    cli()
      .run(
        `--space-id ${SOURCE_TEST_SPACE} --environment-id ${environmentId} ./examples/38-change-field-group-id-editor-layout.js`
      )
  ...
  it('aborts 39-delete-editor-layout migration', (done) => {
    cli()
      .run(
  ...
  it('applies 39-delete-editor-layout migration', (done) => {
    cli()
      .run(
        `--space-id ${SOURCE_TEST_SPACE} --environment-id ${environmentId} ./examples/39-delete-editor-layout.js`
      )
  ...
  it('aborts 40-move-field-in-editor-layout migration', (done) => {
    cli()
      .run(
  ...
  it('applies 40-move-field-in-editor-layout migration', (done) => {
    cli()
      .run(
        `--space-id ${SOURCE_TEST_SPACE} --environment-id ${environmentId} ./examples/40-move-field-in-editor-layout.js`
      )
  ...
  it('aborts 41-move-field-in-existing-editor-layout migration', (done) => {
    cli()
      .run(
  ...
  it('applies 41-move-field-in-existing-editor-layout migration', (done) => {
    cli()
      .run(
        `--space-id ${SOURCE_TEST_SPACE} --environment-id ${environmentId} ./examples/41-move-field-in-existing-editor-layout.js`
      )

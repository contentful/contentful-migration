...
describe('apply sidebar migration examples', () => {
  ...
  it('migrates the sidebar with 24-add-sidebar-widgets-to-new-content-type.js', (done) => {
    cli()
      .run(
  ...
  it('migrates the sidebar with 27-add-sidebar-widgets-to-existing-content-type.js', (done) => {
    cli()
      .run(

...
describe('editor layout plan validation', function () {
  ...
  describe('delete editor layout', function () {
    describe('when deleting an editor layout for a content type that doesn’t exist', function () {
      it('returns an error', async function () {
        const contentTypes = [];

        const errors = await validateChunks(function (migration) {
          const InvalidCt = migration.editContentType('invalid');
          InvalidCt.deleteEditorLayout();
        }, contentTypes);
  ...
  describe('create field group', function () {
    describe('when creating a field group for a content type that doesn’t exist', function () {
      it('returns two errors for creation and update', async function () {
        const contentTypes = [];

        const errors = await validateChunks(function (migration) {
          const InvalidCt = migration.editContentType('invalid');
          const editorLayout = InvalidCt.editEditorLayout();

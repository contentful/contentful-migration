...
describe('field editing plan validation', () => {
  describe('when editing a field that does not exist', () => {
  ...
  describe('when editing a field that was deleted', () => {
    it('returns an error', async () => {
      const contentTypes: any[] = []
      const errors = await validateChunks(function up(migration: any) {
        const person = migration.createContentType('person', {
  ...
  describe('when editing a field on a content type that does not exist', () => {
    it('returns an error', async () => {
      const contentTypes: any[] = []
      const errors = await validateChunks(function up(migration: any) {
  ...
  describe('when setting the same prop more than once but in separate chunks', () => {
    it('does not return errors', async () => {
      const contentTypes: any[] = []
      const errors = await validateChunks(function up(migration: any) {
        const person = migration.createContentType('person')

...
describe('content type delete validation', () => {
  describe('when deleting a content type twice', () => {
  ...
  describe('when deleting several content types several times', () => {
    it('returns the right errors', async () => {
      const contentTypes = [{ sys: { id: 'foo' } }, { sys: { id: 'bar' } }, { sys: { id: 'baz' } }]
  ...
  describe('when deleting a content type that does not exist', () => {
    it('returns an error', async () => {
      const contentTypes = [
        {
          sys: { id: 'foo' }
  ...
  describe('when editing a content type that has been deleted earlier', () => {
    it('returns an error', async () => {
      const contentTypes = [
        {
          sys: { id: 'foo' },
  ...
  describe('when deleting a content type that still has entries', () => {
    it('returns an error', async () => {
      const contentTypes = [
        {
          sys: { id: 'foo' },

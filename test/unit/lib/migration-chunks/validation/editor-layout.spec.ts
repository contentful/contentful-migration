...
describe('editor layout plan validation', () => {
  describe('when calling editor layout method which doesnt exist', () => {
    it('returns an error', async () => {
      ...
      const errors = await validateChunks(function (migration: any) {
  ...
  describe('create editor layout', () => {
    describe('when creating an editor layout for a content type that doesnt exist', () => {
      it('returns an error', async () => {
        const contentTypes = []
        ...
        expect(errors).toEqual([
          {
            type: 'InvalidAction',
            message:
              'You cannot update the editor layout for content type "invalid" because it does not exist.',
            details: {
              step: {
  ...
  describe('create field group', () => {
    describe('when creating a field group with the same id twice', () => {
      it('returns an error', async () => {
        const contentTypes = [
          {
            sys: { id: 'page' }
        ...
        expect(errors).toEqual([
          {
            type: 'InvalidAction',
            message:
              'Field group with id "content" for content type "page" cannot be created more than once.',
            details: {
              step: {
    ...
    describe('when creating a field group that already exists', () => {
      it('returns an error', async () => {
        const contentTypes = [
          {
            sys: { id: 'page' }
    ...
    describe('when field group ID contains invalid character', () => {
      it('returns an error', async () => {
        const contentTypes = [
          {
            sys: { id: 'page' }
        ...
        const errors = await validateChunks(
          function (migration: any) {
            ...
            editorLayout.createFieldGroup('group with wrong character', {
              name: 'Content'
            })
          },
          contentTypes,
        ...
        expect(errors).toEqual([
          {
            type: 'InvalidAction',
            message:
              'Field group id "group with wrong character" for content type "page" must consist of only letters and numbers.',
            details: {
              step: {
                type: 'contentType/createEditorLayoutFieldGroup',
                meta: {
    ...
    describe('when field group ID is empty', () => {
      it('returns an error', async () => {
        const contentTypes = [
          {
            sys: { id: 'page' }
        ...
        expect(errors).toEqual([
          {
            type: 'InvalidAction',
            message:
              'Field group id "" for content type "page" must consist of only letters and numbers.',
            details: {
              step: {
                type: 'contentType/createEditorLayoutFieldGroup',
                meta: {
    ...
    describe('when field group ID starts with number', () => {
      it('returns an error', async () => {
        const contentTypes = [
          {
            sys: { id: 'page' }
        ...
        const errors = await validateChunks(
          function (migration: any) {
            ...
            editorLayout.createFieldGroup('1group', {
              name: 'Content'
            })
          },
          contentTypes,
    ...
    describe('when field group ID is too long', () => {
      it('returns an error', async () => {
        const contentTypes = [
          {
            sys: { id: 'page' }
        ...
        const errors = await validateChunks(
          function (migration: any) {
            ...
            editorLayout.createFieldGroup(
              'fieldGroupWithIdThatContainsTheRightCharactersButIsTooLong',
              {
                name: 'Content'
              }
            )
        ...
        expect(errors).toEqual([
          {
            type: 'InvalidAction',
            message:
              'Field group id "fieldGroupWithIdThatContainsTheRightCharactersButIsTooLong" for content type "page" must not exceed 50 characters.',
            details: {
              step: {
                type: 'contentType/createEditorLayoutFieldGroup',
                meta: {
  ...
  describe('update field group', () => {
    describe('when field group name is too long', () => {
      it('returns an error', async () => {
        const contentTypes = [
          {
            sys: { id: 'page' }
        ...
        expect(errors).toEqual([
          {
            type: 'InvalidAction',
            message:
              'Name for field group with id "content" for content type "page" must not exceed 50 characters.',
            details: {
              step: {
  ...
  describe('change field group control', () => {
    describe('when field group ID does not exist', () => {
      it('returns an error', async () => {
        const contentTypes = [
          {
            sys: { id: 'page' }
  ...
  describe("when deleting a field group that doesn't exist", () => {
    it('returns an error', async () => {
      const contentTypes = [
        {
          sys: { id: 'page' }
      ...
      expect(errors).toEqual([
        {
          type: 'InvalidAction',
          message:
            'You cannot delete a field group with id "content" on content type "page" because it does not exist.',
          details: {
            step: {
  ...
  describe('when deleting a field group with the same id twice', () => {
    it('returns an error', async () => {
      const contentTypes = [
        {
          sys: { id: 'page' }
      ...
      expect(errors).toEqual([
        {
          type: 'InvalidAction',
          message:
            'Field group with id "content" on content type "page" cannot be deleted more than once.',
          details: {
            step: {
              type: 'contentType/deleteEditorLayoutFieldGroup',
              meta: {
  ...
  describe('when saving an editor layout with more than 2 levels deep', () => {
    it('returns an error', async () => {
      const contentTypes = [
        {
          sys: { id: 'page' },
  ...
  describe('when saving an editor layout with more than 5 tabs', () => {
    it('returns an error', async () => {
      const contentTypes = [
        {
          sys: { id: 'page' },
  ...
  describe('when saving an editor layout with a tab that has fieldset control', () => {
    it('returns an error', async () => {
      const contentTypes = [
        {
          sys: { id: 'page' },
  ...
  describe('when saving an editor layout with a field set that has tab control', () => {
    it('returns an error', async () => {
      const contentTypes = [
        {
          sys: { id: 'page' },
        ...
        [
          {
            type: 'InvalidPayload',
            message:
              'Editor layout field set "details" cannot have a "topLevelTab" widget group control'
          }
        ]
      ])
    })
  ...
  describe('when saving an editor layout with less than 2 groups', () => {
    it('returns an error', async () => {
      const contentTypes = [
        {
          sys: { id: 'page' },
  ...
  describe('when saving an editor layout with more than 15 field sets', () => {
    it('returns an error', async () => {
      const contentTypes = [
        {
          sys: { id: 'page' },
      ...
      it('returns an error', async () => {
        const errors = await validateChunks(
          function (migration: any) {
            ...
            editorLayout.moveField('not_existing').toTheTopOfFieldGroup()
          },
          testCts,
          [],
          testEis
      ...
      it('returns an error', async () => {
        const errors = await validateChunks(
          function (migration: any) {
            ...
            editorLayout.moveField('foo').toTheCloud()
          },
          testCts,
          [],
          testEis
      ...
      it('returns an error', async () => {
        const errors = await validateChunks(
          function (migration: any) {
            ...
            editorLayout.moveField('foo').afterField('foo')
          },
          testCts,
          [],
          testEis
      ...
      it('returns an error', async () => {
        const errors = await validateChunks(
          function (migration: any) {
            ...
            editorLayout.moveField('foo').afterField('not_existing')
          },
          testCts,
          [],
          testEis
      ...
      it('returns an error', async () => {
        const errors = await validateChunks(
          function (migration: any) {
            ...
            editorLayout.moveField('foo').afterField()
          },
          testCts,
          [],
          testEis
      ...
      it('returns an error', async () => {
        const errors = await validateChunks(
          function (migration: any) {
            ...
            editorLayout.moveField('foo').afterFieldGroup()
          },
          testCts,
          [],
          testEis
      ...
      it('returns an error', async () => {
        const errors = await validateChunks(
          function (migration: any) {
            ...
            editorLayout.moveField('foo').afterFieldGroup('not_existing_group')
          },
          testCts,
          [],
          testEis
        ...
        expect(errors).toEqual([
          {
            type: 'InvalidAction',
            message:
              'Field "foo" cannot be moved: pivot field group "not_existing_group" does not exist',
            details: {
              step: {
                type: 'contentType/moveFieldInEditorLayout',
                meta: { contentTypeInstanceId: 'contentType/page/0' },
      ...
      it('returns an error', async () => {
        const errors = await validateChunks(
          function (migration: any) {
            ...
            editorLayout.moveField('foo').toTheTopOfFieldGroup('not_existing_group')
          },
          testCts,
          [],
          testEis
        ...
        expect(errors).toEqual([
          {
            type: 'InvalidAction',
            message:
              'Field "foo" cannot be moved: destination group "not_existing_group" does not exist',
            details: {
              step: {
                type: 'contentType/moveFieldInEditorLayout',
                meta: { contentTypeInstanceId: 'contentType/page/0' },
      ...
      it('succeeds', async () => {
        const errors = await validateChunks(
          function (migration: any) {
            ...
            editorLayout.moveField('foo').toTheTopOfFieldGroup()
          },
          testCts,
          [],
          testEis

...
const ContentTypeUpdateValidator =
  require('../../../../src/lib/intent-validator/content-type-update').default
...
describe('migration-steps validation', function () {
  describe('when invoking methods for invalid props', function () {
    it(
      'returns all the validation errors for content types and fields',
    ...
    it(
      'returns validation errors for tags',
      Bluebird.coroutine(function* () {
        const validationErrors = yield validateSteps(function up(migration) {

...
describe('the migration', function () {
  ...
  before(
    co(function* () {
      ...
      organizationId = yield fetcher.getOrganizationIdFromSpace()

      createConceptScheme = taxonomyHelpers.createConceptScheme(request, organizationId)
      createConcept = taxonomyHelpers.createConcept(request, organizationId)
      deleteConceptScheme = taxonomyHelpers.deleteConceptScheme(request, organizationId)
      deleteConcept = taxonomyHelpers.deleteConcept(request, organizationId)
  ...
  it(
    ...
    co(function* () {
      ...
      try {
        ...
        expect(createdContentType.metadata?.taxonomy).to.be.undefined()
      } finally {

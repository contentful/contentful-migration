...
export interface StateIterableInterface<EntityType> {
...
export class State<EntityType> implements StateInterface<EntityType>, StateIterableInterface<EntityType> {

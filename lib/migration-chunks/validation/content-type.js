...
const checkForEditsAfterDelete = function (chunks) {
  const steps = _.flatten(chunks);
...
const formatEditsAfterDeleteErrors = errorFormatter((step) => {
  const id = step.payload.contentTypeId;
...
module.exports = function (chunks, contentTypes) {
  ...
  const editsAfterDeletes = checkForEditsAfterDelete(chunks);
  ...
  const editsAfterDeletesErrors = formatEditsAfterDeleteErrors(editsAfterDeletes);
  ...
  return duplicateErrors
    ...
    .concat(editsAfterDeletesErrors);
};

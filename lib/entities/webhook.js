...
function createWebhookApi (http) {
  return {
     ...
     * @memberof Webhook
     * @func getCalls
     * @return {Promise} Promise for list of calls
     * @example
     * webhook.getCalls()
     ...
     * @memberof Webhook
     * @func getCalls
     * @return {Promise} Promise for call details
     * @example
     ...
     * @memberof Webhook
     * @func getHealth
     * @return {Promise} Promise for health info
     * @example
     * webhook.getHealth()
 ...
 * @prop {number} skip
 * @prop {number} limit
 * @prop {Array<Entities.Webhook>} items

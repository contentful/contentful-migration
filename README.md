...
In your migration description file, export a function that accepts the `migration` object and the `context` for the migrations as its arguments. For example:
